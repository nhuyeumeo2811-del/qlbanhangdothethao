...
const translations = {
    VN: {
        ...
        logout: 'Đăng xuất',
        sportswearMenu: [
            { text: 'Thời Trang Nữ', href: '/sportswear/thoi-trang-nu' },
            { text: 'Thời Trang Nam', href: '/sportswear/thoi-trang-nam' },
        ]
    },
    EN: {
        ...
        logout: 'Logout',
        sportswearMenu: [
            { text: 'Women Fashion', href: '/sportswear/thoi-trang-nu' },
            { text: 'Men Fashion', href: '/sportswear/thoi-trang-nam' },
        ]
    }
};
            ...
            <nav className="header-navigation" aria-label="Điều hướng chính">
                <div className="nav-content">
                    ...
                    <div
                        ...
                        onMouseEnter={() => setHoveredMenu('sportswear')}
                        onMouseLeave={() => setHoveredMenu(null)}
                    >
                        <a
                            href="/sportswear"
                            className={`nav-link ${
                                hoveredMenu === 'sportswear' ? 'active' : ''
                            }`}
                        >
                            {t.sportswear}
                        </a>

                        {hoveredMenu === 'sportswear' && (
                            <div className="dropdown-menu">
                                {t.sportswearMenu.map((item, index) => (
                                    <a
                                        key={index}
                                        href={item.href}
                    ...
                    <a href="/hats" className="nav-link">
                        {t.hats}
                    </a>
